...
// sử dụng fontawesome nếu không dùng tailwindIcon
import "../fontawesome";
...
const Navbar = () => {
  ...
  return (
    <div className=''>
      <div className='flex justify-between px-4 h-14 items-center fixed top-0 z-50 bg-white w-full'>
        <div className='flex items-center '>
          <button className='p-2 hover:rounded-[50%] hover:bg-slate-200'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6">
              <path fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10zm0 5.25a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />
            </svg>
          </button>      
          <Link to="/" className='p-3.5'>
            <img className='w-24 h-5' src={logo}/>
          </Link>
          <span className="text-[10px] relative text-slate-500 top-[-10px] left-[-20px]">VN</span>
        </div>
        <div className="flex">
          <SearchBar/>
